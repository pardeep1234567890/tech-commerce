...
const Hero = () => {
  return (
    <div className="relative h-[60vh] min-h-[400px] w-full bg-black sm:h-[80vh]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
        ...
        <Link
          to="/shop"
          className="mt-8 inline-block border border-white bg-white px-10 py-3 text-sm font-medium uppercase tracking-wider text-black transition-colors hover:bg-transparent hover:text-white"
        >
          Shop Now
        </Link>
      </div>
